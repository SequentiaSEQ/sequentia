...
{
    update_ancestor_state(int64_t _modifySize, CValue _modifyFee, int64_t _modifyCount, int64_t _modifySigOpsCost, int64_t _discountSize) :
...
void CTxMemPoolEntry::UpdateAncestorState(int64_t modifySize, CValue modifyFee, int64_t modifyCount, int64_t modifySigOps, int64_t discountSize)
{
